...
export function DataTable<TData, TValue>({
  ...
  const table = useReactTable({
    ...
    globalFilterFn: (row, columnId, filterValue) => {
      const searchableFields = ["eventTitle", "ticketCode", "name", "whatsapp"];
    ...
    <div>
      <div className="px-6 py-4 sm:px-0">
        <div className="grid grid-cols-3 items-center gap-4 lg:grid-cols-5">
          <Input
            placeholder="Search by title, name, ticket code, or whatsapp..."
            value={globalFilter ?? ""}
            onChange={(event) => setGlobalFilter(event.target.value)}
            className="col-span-3 w-full lg:col-span-2 lg:max-w-sm"
          />
          <Select
            value={
              (table.getColumn("presence")?.getFilterValue() as string) ?? "All"
            }
            onValueChange={(value) =>
              table
                .getColumn("presence")
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="All">Kehadiran</SelectItem>
          ...
          <Select
            value={
              (table.getColumn("ticketType")?.getFilterValue() as string) ??
              "All"
            }
            onValueChange={(value) =>
              table
          ...
          >
            ...
            <SelectContent>
              <SelectItem value="All">Tipe Tiket</SelectItem>
