  ...
  return (
    <div>
      <div className="px-6 py-4 sm:px-0">
        <div className="grid grid-cols-3 items-center gap-4 lg:grid-cols-6">
          <Input
            placeholder="Search by event, ticket, name, or whatsapp..."
            value={globalFilter ?? ""}
            onChange={(event) => setGlobalFilter(event.target.value)}
            className="col-span-3 w-full lg:col-span-3 lg:max-w-sm"
          />
          <Select
            value={
